...
<head>
  ...
  <style>
    ...
    .area {{ max-height:72vh; overflow:auto; border:1px solid #e5e7eb; border-radius:10px; }}
    .area-sm {{ max-height:48vh; overflow:auto; border:1px solid #e5e7eb; border-radius:10px; margin-top:12px; }}
    table {{ width:100%; border-collapse:collapse; font-size:13px; }}
    th,td {{ border-bottom:1px solid #e5e7eb; text-align:left; padding:8px; vertical-align:top; }}
    th {{ background:#f8fafc; position:sticky; top:0; }}
    .tag {{ display:inline-block; border-radius:999px; background:#eef2ff; color:#3730a3; padding:2px 8px; font-size:12px; }}
    .muted {{ color:#6b7280; }}
